package com.demo.gateway.server.service.securityAPI;
...
public class SecurityApiRpcService {
     ...
     * @param clientConfig
     */
    public void verifySignature(String body, String signature, com.demo.gateway.server.model.dto.ClientConfig clientConfig) {
     ...
     * @throws Exception
     */
    public String sign(String body, com.demo.gateway.server.model.dto.ClientConfig client, PrivateKey privateKey) throws Exception {
