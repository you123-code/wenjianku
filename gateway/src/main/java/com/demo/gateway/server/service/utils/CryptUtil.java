...
//            keyBte  = secretKey.getEncoded();
    ...
    public static ClientConfig getClientConfig(String clientId) {
        List<com.demo.gateway.server.model.dto.ClientConfig> list = new ArrayList<com.demo.gateway.server.model.dto.ClientConfig>() {{
            add(com.demo.gateway.server.model.dto.ClientConfig.builder()
        ...
        com.demo.gateway.server.model.dto.ClientConfig collect = list.stream().filter(c -> c.getClientId().equals(clientId)).collect(Collectors.toList()).get(0);
